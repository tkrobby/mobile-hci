...
Mobile.setText(findTestObject('Register/android.widget.EditText0 - Masukkan No. Handphone Anda'), '8157121233', 10)
...
Mobile.verifyElementText(findTestObject('Object Repository/Register/CreateAccount/android.widget.TextView0 - Kode OTP salah'), 'Kode OTP salah')
Mobile.tap(findTestObject('Object Repository/Register/CreateAccount/android.widget.Button0 - OK'), 2 )
